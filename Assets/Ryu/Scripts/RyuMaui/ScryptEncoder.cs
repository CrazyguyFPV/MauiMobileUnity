...
namespace Scrypt
{
    ...
    public class ScryptEncoder
    {
        ...
        /// Hash a password using the scrypt scheme.
        /// </summary>
        public static string EncodeV2(string password, byte[] saltBytes, int iterationCount, int blockSize, int threadCount)
        {
        ...
        /// Copies a specified number of bytes from a source pointer to a destination pointer.
        /// </summary>
        public unsafe static void BulkXor(void* dst, void* src, int len)
        {
            var d = (byte*)dst;
            var s = (byte*)src;
